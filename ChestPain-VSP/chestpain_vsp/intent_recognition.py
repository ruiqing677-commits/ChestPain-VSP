...
class ChestPainIntentRecognizer:
    ...
    def __init__(
        ...
        load_env_file()
        self.model = model or os.environ.get("CHESTPAIN_VSP_INTENT_MODEL") or os.environ.get("CHESTPAIN_VSP_MODEL", "gpt-4o-mini")
        self.temperature = temperature
        self.use_llm = use_llm
        self._client = get_openai_client(api_key, base_url) if use_llm else None
