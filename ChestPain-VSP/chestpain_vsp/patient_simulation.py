...
from .utils import compact_text, get_llm_client, load_env_file
...
class ChestPainVirtualPatient:
    """Configurable LLM-based virtual standardized patient for chest-pain cases."""
    ...
    def __init__(
        ...
        load_env_file()
        self.model = model or os.environ.get("CHESTPAIN_VSP_MODEL", "your_model_name")
